        ...
        try:
            ...
            if "result" in data:
                ...
                if clan_id:
                    if clan_id == 4488:
                        self.log(
                            "🔄 Already in clan 4488. No action needed.", Fore.CYAN
                        )
                    else:
                        self.log(
                        ...
                        self.log("🔄 Attempting to join clan 4488...", Fore.CYAN)
                        join_payload = {"clan_id": 4488}
                        try:
                            ...
                            self.log("✅ Successfully joined clan 4488.", Fore.GREEN)
                        except Exception as e:
